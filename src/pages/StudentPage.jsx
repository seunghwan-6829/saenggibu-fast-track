      ...
      <main className="main-content center-content">
        <header className="top-nav" style={{ justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
             {/* Admin Link */}
             <button onClick={() => navigate('/admin')} style={{ color: '#94a3b8', fontSize: '0.85rem' }}>👩‍🏫 관리자</button>
             
             <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem' }}>
                <img src={currentUser.profileImg} alt="profile" style={{ width: '32px', height: '32px', borderRadius: '50%' }} />
