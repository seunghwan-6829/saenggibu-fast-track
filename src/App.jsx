...
const mockCurriculum = [
  ...
  { id: 2, title: '02. 한 눈에 보는 A to Z 상세페이지 제작', durationStr: '05:24', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
  { id: 3, title: '03. 이렇게 하면 됩니다. 상세페이지 장단점 분석', durationStr: '05:36', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
  { id: 4, title: '04. 같은 제품이라도 차별화를 두는 핵심 방법', durationStr: '04:36', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
  { id: 5, title: '05. 소비자의 심리를 활용한 상세페이지 제작 방법', durationStr: '04:57', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
  { id: 6, title: '06. 구매 유발하는 카피라이팅 작성 방법', durationStr: '05:31', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
  { id: 7, title: '07. 톤앤매너로 일관된 상세페이지 제작 방법', durationStr: '04:19', completed: false, videoSrc: 'https://vjs.zencdn.net/v/oceans.mp4' },
];
